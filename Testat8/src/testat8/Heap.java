...
public class Heap<E> implements Serializable{
   ...
   /**
	 * 
	 */
   private static final long serialVersionUID = -4315146867101183449L;
   ...
   /**
    * schreibt jedes Objects in einen ObjectOutputStream
    * @param s	ObjectOutputStream, in den geschrieben wird
    * @throws IOException
    */
   ...
   /**
    * liest Objects aus einem ObjectInputStream und schreibt sie in den Heap
    * @param s	ObjectInputStream, aus dem gelesen wird
    * @throws IOException
    */
